({
    ...
    handleSubmit : function(component, event, helper) {
        ...
        // Use selected user (from custom search field) or current user
        var selectedUserId = component.get("v.selectedUserId");
        var targetUserId   = selectedUserId ? selectedUserId : $A.get("$SObjectType.CurrentUser.Id");
        ...
        action.setParams({
            "leaveData": {
                ...
                "Session_Type__c": fields.Session_Type__c
            }
        });
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if (errorMsg) {
                    helper.showToast(
                        "You have already applied for leave on the selected date(s).",
                        errorMsg,
                        "error"
                    );
                    component.set("v.isProcessing", false);
                    ...
                    if (showUserField) {
                        ...
                        fields.Leave_Approved_Date__c = yyyy + '-' + mm + '-' + dd;
                    }
    ...
    handleUserSelect : function(component, event, helper) {
        ...
        component.set("v.userSearchTerm",    userName);
        component.set("v.showUserDropdown",  false);
        component.set("v.userSearchResults", []);
    },

    handleUserBlur : function(component, event, helper) {
    ...
    handleClearUser : function(component, event, helper) {
        component.set("v.selectedUserId",    "");
        component.set("v.selectedUserName",  "");
        component.set("v.userSearchTerm",    "");
        component.set("v.userSearchResults", []);
        component.set("v.showUserDropdown",  false);
    }
})