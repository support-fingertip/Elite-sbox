...
export default class SubStockiestExistingForm extends LightningElement {
...
visitTypeOptions = [
    { label:'Existing Market Expansion', value:'Existing'}
];
...
handleSubmit(){
    ...
    console.log('Sub Stockiest Existing Submitted');
