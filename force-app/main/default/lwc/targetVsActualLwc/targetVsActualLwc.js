...
// Stubs while TargetVsActualLwc is disabled
const getData = () => Promise.reject('TargetVsActualLwc is currently disabled');
const getTargetActuals = () => Promise.reject('TargetVsActualLwc is currently disabled');
const getUserTargetActuals = () => Promise.reject('TargetVsActualLwc is currently disabled');
const saveTargets = () => Promise.reject('TargetVsActualLwc is currently disabled');
const saveAdminTargetActuals = () => Promise.reject('TargetVsActualLwc is currently disabled');
