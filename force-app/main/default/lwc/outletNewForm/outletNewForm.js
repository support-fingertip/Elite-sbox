...
import saveOutletNewMarket from '@salesforce/apex/VisitFormController.saveOutletNewMarket';
...
export default class ExistingSecondaryCustomer extends NavigationMixin(LightningElement) {
    ...
    handleGetLatLon() {
        ...
        if (!this.customerBusinessType) {
            this.showToast('Error', 'Please select Secondary Customer Bussiness Type', 'error');
            return;
        }
